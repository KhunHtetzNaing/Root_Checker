package com.htetznaing.rchecker;
...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.rchecker", "com.htetznaing.rchecker.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.rchecker", "com.htetznaing.rchecker.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.rchecker.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._banner.Initialize2(mostCurrent.activityBA,"banner","ca-app-pub-4173348573252986/8681142956",mostCurrent._banner.SIZE_SMART_BANNER);
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 48;BA.debugLine="interstitial.Initialize(\"interstitial\",\"ca-app-p";
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"interstitial","ca-app-pub-4173348573252986/1157876151");
 //BA.debugLineNum = 49;BA.debugLine="interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 51;BA.debugLine="t1.Initialize(\"t1\",100)";
_t1.Initialize(processBA,"t1",(long) (100));
 //BA.debugLineNum = 52;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 54;BA.debugLine="t2.Initialize(\"t2\",30000)";
_t2.Initialize(processBA,"t2",(long) (30000));
 //BA.debugLineNum = 55;BA.debugLine="t2.Enabled = True";
_t2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 57;BA.debugLine="Activity.Color = Colors.White";
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 58;BA.debugLine="Select p.SdkVersion";
...
case 0: {
 //BA.debugLineNum = 59;BA.debugLine="Case 2 : OS = \"1.1\"";
mostCurrent._os = "1.1";
 break; }
case 1: {
 //BA.debugLineNum = 60;BA.debugLine="Case 3 : OS = \"1.5\"";
mostCurrent._os = "1.5";
 break; }
case 2: {
 //BA.debugLineNum = 61;BA.debugLine="Case 4 : OS = \"1.6\"";
mostCurrent._os = "1.6";
 break; }
case 3: {
 //BA.debugLineNum = 62;BA.debugLine="Case 5 : OS = \"2.0\"";
mostCurrent._os = "2.0";
 break; }
case 4: {
 //BA.debugLineNum = 63;BA.debugLine="Case 6 : OS = \"2.0.1\"";
mostCurrent._os = "2.0.1";
 break; }
case 5: {
 //BA.debugLineNum = 64;BA.debugLine="Case 7 : OS = \"2.1\"";
mostCurrent._os = "2.1";
 break; }
case 6: {
 //BA.debugLineNum = 65;BA.debugLine="Case 8 : OS = \"2.2\"";
mostCurrent._os = "2.2";
 break; }
case 7: {
 //BA.debugLineNum = 66;BA.debugLine="Case 9 : OS = \"2.3 - 2.3.2\"";
mostCurrent._os = "2.3 - 2.3.2";
 break; }
case 8: {
 //BA.debugLineNum = 67;BA.debugLine="Case 10 : OS = \"	2.3.3 - 2.3.7\" ' 2.3.3 or 2.3.";
mostCurrent._os = "	2.3.3 - 2.3.7";
 break; }
case 9: {
 //BA.debugLineNum = 68;BA.debugLine="Case 11 : OS = \"3.0\"";
mostCurrent._os = "3.0";
 break; }
case 10: {
 //BA.debugLineNum = 69;BA.debugLine="Case 12 : OS = \"3.1\"";
mostCurrent._os = "3.1";
 break; }
case 11: {
 //BA.debugLineNum = 70;BA.debugLine="Case 13 : OS = \"3.2\"";
mostCurrent._os = "3.2";
 break; }
case 12: {
 //BA.debugLineNum = 71;BA.debugLine="Case 14 : OS = \"	4.0.1 - 4.0.2\"";
mostCurrent._os = "	4.0.1 - 4.0.2";
 break; }
case 13: {
 //BA.debugLineNum = 72;BA.debugLine="Case 15 : OS = \"4.0.3 - 4.0.4\"";
mostCurrent._os = "4.0.3 - 4.0.4";
 break; }
case 14: {
 //BA.debugLineNum = 73;BA.debugLine="Case 16 : OS = \"	4.1.x\"";
mostCurrent._os = "	4.1.x";
 break; }
case 15: {
 //BA.debugLineNum = 74;BA.debugLine="Case 17 : OS = \"	4.2.x\"";
mostCurrent._os = "	4.2.x";
 break; }
case 16: {
 //BA.debugLineNum = 75;BA.debugLine="Case 18 : OS = 	\"4.3.x\"";
mostCurrent._os = "4.3.x";
 break; }
case 17: {
 //BA.debugLineNum = 76;BA.debugLine="Case 19 : OS = \"	4.4 - 4.4.4\"";
mostCurrent._os = "	4.4 - 4.4.4";
 break; }
case 18: {
 //BA.debugLineNum = 77;BA.debugLine="Case 21: OS = \"5.0\"";
mostCurrent._os = "5.0";
 break; }
case 19: {
 //BA.debugLineNum = 78;BA.debugLine="Case 22: OS = \"5.1\"";
mostCurrent._os = "5.1";
 break; }
case 20: {
 //BA.debugLineNum = 79;BA.debugLine="Case 23: OS = \"6.0\"";
mostCurrent._os = "6.0";
 break; }
case 21: {
 //BA.debugLineNum = 80;BA.debugLine="Case 24 : OS = \"	7.0\"";
mostCurrent._os = "	7.0";
 break; }
case 22: {
 //BA.debugLineNum = 81;BA.debugLine="Case 25 : OS = \"	7.1\"";
mostCurrent._os = "	7.1";
 break; }
default: {
 //BA.debugLineNum = 82;BA.debugLine="Case Else : OS = \"?\"";
mostCurrent._os = "?";
 break; }
}
;
 //BA.debugLineNum = 85;BA.debugLine="imv.Initialize(\"imv\")";
mostCurrent._imv.Initialize(mostCurrent.activityBA,"imv");
 //BA.debugLineNum = 86;BA.debugLine="imv.Bitmap = LoadBitmap(File.DirAssets,\"icon.png\")";
mostCurrent._imv.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icon.png").getObject()));
 //BA.debugLineNum = 87;BA.debugLine="imv.Gravity = Gravity.FILL";
mostCurrent._imv.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 88;BA.debugLine="Activity.AddView(imv,50%x - 50dip,10dip, 100dip, 1";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imv.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)));
 //BA.debugLineNum = 90;BA.debugLine="About.Initialize(\"\")";
mostCurrent._about.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 91;BA.debugLine="About.Text = \"Brand Name : \" & p.Manufacturer & CR";
mostCurrent._about.setText((Object)("Brand Name : "+mostCurrent._p.getManufacturer()+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Device Name : "+mostCurrent._p.getModel()+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Androide Version : "+mostCurrent._os));
 //BA.debugLineNum = 92;BA.debugLine="Activity.AddView(About,0%x,(imv.Height+imv.Top),10";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._about.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._imv.getHeight()+mostCurrent._imv.getTop())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120)));
 //BA.debugLineNum = 93;BA.debugLine="About.Gravity = Gravity.CENTER";
mostCurrent._about.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 94;BA.debugLine="About.TextColor = Colors.Black";
mostCurrent._about.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 96;BA.debugLine="Dim bbg As ColorDrawable";
_bbg = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 97;BA.debugLine="bbg.Initialize(Colors.Black,10)";
...
mostCurrent._b.Initialize(mostCurrent.activityBA,"b");
 //BA.debugLineNum = 99;BA.debugLine="b.Background = bbg";
mostCurrent._b.setBackground((android.graphics.drawable.Drawable)(_bbg.getObject()));
 //BA.debugLineNum = 100;BA.debugLine="b.Text = \"#Verify Root Status\"";
mostCurrent._b.setText((Object)("#Verify Root Status"));
 //BA.debugLineNum = 101;BA.debugLine="Activity.AddView(b,20%x,(About.Top+About.Height),6";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) ((mostCurrent._about.getTop()+mostCurrent._about.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 103;BA.debugLine="ivyes.Initialize(\"ivyes\")";
mostCurrent._ivyes.Initialize(mostCurrent.activityBA,"ivyes");
 //BA.debugLineNum = 104;BA.debugLine="ivyes.Bitmap = LoadBitmap(File.DirAssets,\"yes.png\"";
mostCurrent._ivyes.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"yes.png").getObject()));
 //BA.debugLineNum = 105;BA.debugLine="ivyes.Gravity = Gravity.FILL";
mostCurrent._ivyes.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 106;BA.debugLine="Activity.AddView(ivyes,50%x - 30dip  , (About.Top+";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._ivyes.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),(int) ((mostCurrent._about.getTop()+mostCurrent._about.getHeight())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 107;BA.debugLine="ivyes.Visible = False";
mostCurrent._ivyes.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 109;BA.debugLine="ivno.Initialize(\"ivno\")";
mostCurrent._ivno.Initialize(mostCurrent.activityBA,"ivno");
 //BA.debugLineNum = 110;BA.debugLine="ivno.Bitmap = LoadBitmap(File.DirAssets,\"no.png\")";
mostCurrent._ivno.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"no.png").getObject()));
 //BA.debugLineNum = 111;BA.debugLine="ivno.Gravity = Gravity.FILL";
mostCurrent._ivno.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 112;BA.debugLine="Activity.AddView(ivno,50%x - 30dip , (About.Top+Ab";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._ivno.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),(int) ((mostCurrent._about.getTop()+mostCurrent._about.getHeight())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 113;BA.debugLine="ivno.Visible = False";
mostCurrent._ivno.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 115;BA.debugLine="yes.Initialize(\"yes\")";
mostCurrent._yes.Initialize(mostCurrent.activityBA,"yes");
 //BA.debugLineNum = 116;BA.debugLine="yes.Text = \"Congratulations :)\" &CRLF& \"Root Acc";
mostCurrent._yes.setText((Object)("Congratulations :)"+anywheresoftware.b4a.keywords.Common.CRLF+"Root Access is Properly Installed on Your Device!"));
 //BA.debugLineNum = 117;BA.debugLine="yes.Gravity = Gravity.CENTER";
mostCurrent._yes.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 118;BA.debugLine="yes.TextColor = Colors.Green";
mostCurrent._yes.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 119;BA.debugLine="Activity.AddView(yes,0%x,(ivyes.Top+ivyes.Height";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._yes.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._ivyes.getTop()+mostCurrent._ivyes.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 120;BA.debugLine="yes.Visible = False";
mostCurrent._yes.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 122;BA.debugLine="no.Initialize(\"no\")";
mostCurrent._no.Initialize(mostCurrent.activityBA,"no");
 //BA.debugLineNum = 123;BA.debugLine="no.Text =  \"Sorry :(\" &CRLF& \"Root Access is Not";
mostCurrent._no.setText((Object)("Sorry :("+anywheresoftware.b4a.keywords.Common.CRLF+"Root Access is Not Properly Installed on Your Device!"+anywheresoftware.b4a.keywords.Common.CRLF+"How to Root Your Device ?"));
 //BA.debugLineNum = 124;BA.debugLine="no.Gravity = Gravity.CENTER";
mostCurrent._no.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 125;BA.debugLine="no.TextColor = Colors.Red";
mostCurrent._no.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 126;BA.debugLine="Activity.AddView(no,0%x,(ivno.Top+ivno.Height)+2";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._no.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._ivno.getTop()+mostCurrent._ivno.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (15),mostCurrent.activityBA));
 //BA.debugLineNum = 127;BA.debugLine="no.Visible = False";
mostCurrent._no.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 129;BA.debugLine="lf.Initialize(\"lf\")";
mostCurrent._lf.Initialize(mostCurrent.activityBA,"lf");
 //BA.debugLineNum = 130;BA.debugLine="lf.Text = \"Powered By Myanmar Android Apps\"";
mostCurrent._lf.setText((Object)("Powered By Myanmar Android Apps"));
 //BA.debugLineNum = 131;BA.debugLine="lf.Gravity = Gravity.CENTER";
mostCurrent._lf.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 132;BA.debugLine="lf.TextColor = Colors.Blue";
mostCurrent._lf.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 133;BA.debugLine="Activity.AddView(lf,0%x,100%y - 130dip,100%x,10%";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 195;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/MyanmarAndroidAp";
mostCurrent._ml.rmrf(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyanmarAndroidApps");
 //BA.debugLineNum = 196;BA.debugLine="Dim Answ As Int";
_answ = 0;
 //BA.debugLineNum = 197;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 198;BA.debugLine="Answ = Msgbox2(\"If you want to get new updates o";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2("If you want to get new updates on  Facebook? Please Like "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Android Apps Page!","Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fb.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 199;BA.debugLine="If Answ = DialogResponse.NEGATIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.NEGATIVE) { 
 //BA.debugLineNum = 200;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 201;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 };
 //BA.debugLineNum = 204;BA.debugLine="If Answ = DialogResponse.POSITIVE Then";
if (_answ==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 205;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 206;BA.debugLine="Try";
try { //BA.debugLineNum = 208;BA.debugLine="Dim Facebook As Intent";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e17); //BA.debugLineNum = 215;BA.debugLine="Dim i As Intent";
...
_i.Initialize(_i.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(i)";
...
public static String  _b_click() throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub b_Click";
 //BA.debugLineNum = 142;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 143;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 144;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 145;BA.debugLine="ivno.Visible = False";
mostCurrent._ivno.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 146;BA.debugLine="b.Visible = False";
mostCurrent._b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 147;BA.debugLine="no.Visible = False";
mostCurrent._no.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 148;BA.debugLine="ivyes.Visible = True";
mostCurrent._ivyes.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 149;BA.debugLine="yes.Visible = True";
mostCurrent._yes.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 151;BA.debugLine="ivno.Visible = True";
mostCurrent._ivno.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 152;BA.debugLine="b.Visible = False";
mostCurrent._b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 153;BA.debugLine="no.Visible = True";
mostCurrent._no.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 154;BA.debugLine="ivyes.Visible = False";
mostCurrent._ivyes.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 155;BA.debugLine="yes.Visible = False";
mostCurrent._yes.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
...
public static String  _imv_click() throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub imv_Click";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub interstitial_AdClosed";
 //BA.debugLineNum = 182;BA.debugLine="interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _i = null;
 //BA.debugLineNum = 160;BA.debugLine="Sub no_Click";
 //BA.debugLineNum = 161;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 162;BA.debugLine="Dim i As PhoneIntents";
_i = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 163;BA.debugLine="StartActivity(i.OpenBrowser(\"http://www.htetznain";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.OpenBrowser("http://www.htetznaing.com")));
...
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 173;BA.debugLine="If interstitial.Ready Then interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
 //BA.debugLineNum = 174;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 175;BA.debugLine="End Sub";
return "";
}
public static String  _t2_tick() throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub t2_Tick";
 //BA.debugLineNum = 178;BA.debugLine="If interstitial.Ready Then interstitial.Show Else";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();}
else {
mostCurrent._interstitial.LoadAd();};
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _i = null;
 //BA.debugLineNum = 166;BA.debugLine="Sub yes_Click";
 //BA.debugLineNum = 167;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 168;BA.debugLine="Dim i As PhoneIntents";
_i = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(i.OpenBrowser(\"http://www.htetznain";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.OpenBrowser("http://www.htetznaing.com")));
